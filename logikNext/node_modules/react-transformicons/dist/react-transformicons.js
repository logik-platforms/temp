...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js??ref--1-1!./transformicons.css", function() {
			var newContent = require("!!../node_modules/css-loader/index.js??ref--1-1!./transformicons.css");
...
var _transformicons = __webpack_require__(1);
...
var BaseIconButton = function (_React$Component) {
  _inherits(BaseIconButton, _React$Component);

  function BaseIconButton(props) {
    _classCallCheck(this, BaseIconButton);

    var _this = _possibleConstructorReturn(this, (BaseIconButton.__proto__ || Object.getPrototypeOf(BaseIconButton)).call(this, props));

    var isActive = props.isActive ? props.isActive : false;
  ...
  _createClass(BaseIconButton, [{
    ...
    value: function render() {
      var animation = this.props.animations[this.props.animation ? this.props.animation : this.props.defaultAnimation];
      var transform = this.state.active ? 'tcon-transform' : '';
      var animationClass = animation.map(function (s) {
        return _transformicons2.default['' + s];
      }).join(' ');
      var buttonClass = [_transformicons2.default.tcon, animationClass, _transformicons2.default['' + transform]].join(' ');
...
exports.default = BaseIconButton;
...
module.exports = {
  GridIcon: _grid2.default,
  MenuIcon: _menu2.default,
  AddIcon: _add2.default,
  RemoveIcon: _remove2.default,
  ContactIcon: _contact2.default,
  FormIcon: _form2.default,
  VideoIcon: _video2.default,
  ScrollIcon: _scroll2.default,
  LoaderIcon: _loader2.default
};
...
function GridIcon(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement('span', {
      'aria-hidden': 'true',
      className: _transformicons2.default['tcon-grid__item']
    }),
    _react2.default.createElement(
      'span',
      { className: _transformicons2.default['tcon-visuallyhidden'] },
      'toggle grid'
    )
  );
};
...
/*
 ...
 LICENSE file in the root directory of this source tree.
*/
var f=__webpack_require__(6),p=__webpack_require__(7);__webpack_require__(4);var r=__webpack_require__(5);
...
exports.locals = {
	...
	"tcon-plus--minusfold": "tcon-plus--minusfold",
	"tcon-plus--circle": "tcon-plus--circle",
...
function MenuIcon(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement('span', {
      'aria-hidden': 'true',
      className: _transformicons2.default['tcon-menu__lines']
    }),
    _react2.default.createElement(
      'span',
      { className: _transformicons2.default['tcon-visuallyhidden'] },
...
var defaultAnimation = 'mail';
var contactAnimations = {
...
function ContactIcon(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement('span', {
      'aria-hidden': 'true',
      className: _transformicons2.default['tcon-mail--envelope__flap']
    }),
    _react2.default.createElement(
      'span',
      { className: _transformicons2.default['tcon-visuallyhidden'] },
...
function FormIcon(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement('span', {
      'aria-hidden': 'true',
      className: _transformicons2.default['tcon-search__item']
    }),
    _react2.default.createElement(
      'span',
      { className: _transformicons2.default['tcon-visuallyhidden'] },
...
function ScrollIcon(props) {
  return _react2.default.createElement(
    'svg',
    {
      className: _transformicons2.default['tcon-svgchevron'],
      version: '1.1',
      viewBox: '0 0 30 36',
      xmlns: 'http://www.w3.org/2000/svg'
    },
    _react2.default.createElement('path', {
      className: _transformicons2.default.a3,
      d: 'M0,0l15,16L30,0'
    }),
    _react2.default.createElement('path', {
      className: _transformicons2.default.a2,
      d: 'M0,10l15,16l15-16'
    }),
    _react2.default.createElement('path', {
      className: _transformicons2.default.a1,
      d: 'M0,20l15,16l15-16'
    })
  );
};
...
function LoaderIcon(props) {
  return _react2.default.createElement(
    ...
    {
      'aria-label': 'loading',
      className: _transformicons2.default['tcon-loader--spinner360']
    },
    _react2.default.createElement(
      'span',
      { className: _transformicons2.default['tcon-visuallyhidden'] },
